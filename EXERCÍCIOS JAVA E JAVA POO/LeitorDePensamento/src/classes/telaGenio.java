...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() {
        initComponents();
        lblFrase.setText("<html>Vou pesar em um valor entre <strong>1 e 5</strong>. Tente advinhar!<html>");
    }
    ...
    private void initComponents() {
        ...
        lblFrase.setFont(new java.awt.Font("Lucida Fax", 0, 11)); // NOI18N
        lblFrase.setForeground(new java.awt.Color(255, 0, 0));
        lblFrase.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblFrase.setText("Frase");
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 70, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/download.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 240, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/download (2).jpeg"))); // NOI18N
        ...
        btnPalpite.setActionCommand("n1");
        btnPalpite.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPalpiteActionPerformed(evt);
            }
        });
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 120, 70));
