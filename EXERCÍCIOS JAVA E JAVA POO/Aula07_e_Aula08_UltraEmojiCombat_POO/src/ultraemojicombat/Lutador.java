...
public class Lutador {
    ...
    public void apresentar(){
        System.out.println("------------------------------------------------------");
        System.out.println("CHEGOU A HORA! Apresentammos o lutador "+ this.getNome()+".");
        ...
        System.out.print("Ele tem " + this.getVitorias() + " vitória(s) ");
        System.out.print(this.getDerrotas() + " derrota(s) e ");
